...
const TodoItem: FC<TodoItemProps> = ({ todo, index }) => {
  ...
  return (
    <>
      <div
        key={todo.id}
        className="border border-[#EB4608] p-5 mb-5 rounded-2xl flex justify-between items-center hover:scale-105 transition-all last:mb-0"
      >
        ...
        <div className="flex">
          ...
          {pageLocation && (
            <button
              ...
              className="ml-3 text-xl font-bold border border-red-600 text-[#EB4608] px-3 py-2 rounded-xl hover:bg-red-300 hover:text-slate-800 cursor-pointer"
            >
              Full delete
            </button>
          )}
